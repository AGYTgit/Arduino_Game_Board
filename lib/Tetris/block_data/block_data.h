...
const Block_data BLOCK_DATA[7] = { 
    {0x07FF, B00010100, B11110000, {{0, 1},{1, 0},{1, 1},{0, 1}}}, // I
    {0x001F, B00100011, B10011100, {{0, 0},{1, 0},{0, 1},{0, 0}}}, // J
    {0xFBE0, B00100011, B00111100, {{0, 0},{1, 0},{0, 1},{0, 0}}}, // L
    {0xFFE0, B00100010, B11110000, {{0, 0},{0, 0},{0, 0},{0, 0}}}, // O
    {0x07E0, B00100011, B01111000, {{0, 0},{1, 0},{0, 1},{0, 0}}}, // S
    {0xF81F, B00100011, B01011100, {{0, 0},{1, 0},{0, 1},{0, 0}}}, // T
    {0xF800, B00100011, B11001100, {{0, 0},{1, 0},{0, 1},{0, 0}}}  // Z
};
